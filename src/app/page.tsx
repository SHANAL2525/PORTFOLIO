    ...
    <main className="mx-auto max-w-5xl px-4">
          ...
          <div className="grid items-center gap-10 md:grid-cols-[1fr_280px]">
            ...
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-white md:text-5xl">
                Shanal Thanushka{" "}
                <span className="text-white/70">Weerathunga</span>
              </h1>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <a
                  href="#projects"
                  className="rounded-2xl bg-white px-5 py-2.5 text-sm font-medium text-black hover:bg-white/90"
                >
                  View Projects
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-2xl border border-white/15 bg-black/40 px-5 py-2.5 text-sm font-medium text-white/85 hover:text-white"
                >
                  GitHub
                </a>
                <a
                  href="#contact"
                  className="rounded-2xl border border-white/15 bg-white/10 px-5 py-2.5 text-sm font-medium text-white/85 hover:text-white"
                >
                  Contact
                </a>
              </div>
            ...
            >
              ...
              <div className="rounded-full p-[2px] bg-[conic-gradient(from_180deg,rgba(59,130,246,0.9),rgba(168,85,247,0.7),rgba(59,130,246,0.9))]">
                <div className="rounded-full bg-black p-2">
                  <Image
                    src="/me.png" // put your photo in /public/me.jpg
      ...
      <section id="projects" className="py-10">
        <div className="flex items-end justify-between gap-4">
          ...
          <p className="text-sm text-white/50">3 selected</p>
        </div>
      ...
      <section id="certifications" className="py-10">
          ...
          {certifications.map((c) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                {c.url ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-xl border border-blue-400/40 bg-blue-500/10 px-3 py-1 text-xs font-medium text-blue-300 hover:bg-blue-500/20 hover:border-blue-400 transition"
                  >
                    View
                  </a>
                ) : (
              ...
              <p className="mt-3 text-sm text-white/65">
                Verified certificate from {c.issuer}.
              </p>
            </div>
          ))}
        </div>
        ...
        <p className="mt-4 text-xs text-white/40">
          Certificates support my internship preparation; projects show my real-world skills.
        </p>
      </section>
